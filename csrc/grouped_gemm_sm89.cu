...
#include "fill_arguments_sm89.cuh"
...
namespace cutlass {
  namespace gemm {
    namespace device {
      ...
      >
      struct SM89DefaultGemmConfiguration;
      template <typename ElementA, typename ElementB, typename ElementC,
          typename ElementAccumulator>      
      struct SM89DefaultGemmConfiguration<arch::OpClassTensorOp, arch::Sm80, ElementA,
...
using GroupedGemmConfig = ::cutlass::gemm::device::SM89DefaultGemmConfiguration<
